        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Sanchez | Carne Argentina</span>
              <img
                className="h-8 lg:h-10 w-auto"
                src="/assets/Sanchez-H.svg"
                alt="Sanchez Logo"
              />
            </a>
          </div>
          <div className="flex lg:hidden">
            <button
              type="button"
              className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-[#31231E]"
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-sm font-semibold leading-6 text-[#31231E]">
                {item.name}
              </a>
            ))}
          </div>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="-m-2.5 rounded-md p-2.5 text-[#31231E]"
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-28">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-6 text-[#31231E]">
              Abastecedores de carne vacuna en la provincia de Buenos Aires.
              Atendemos a carnicerías, cámaras de distribuidores, desde 1994.
            </p>
